...
def criar_interface():
    ...
    btnEncontrarPendrive = Button(root, text="Encontrar Pendrive", fg="red", command=alterar_labelPendrive(lblPendrive))
    ...
    btnSalvar = Button(root, text="Salvar no pendrive", fg="red", command=salvar_config_interface(configServ, configColetor, lblStatus))
